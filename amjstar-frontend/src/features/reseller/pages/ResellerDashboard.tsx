    ...
    <div className={styles.overview}>
      <div className={styles.statsGrid}>
        <div className={styles.statCard}>
          <div className={styles.statIcon} style={{ background: '#f1f5f9', color: '#0369a1' }}><TrendingUp size={24} /></div>
        ...
        <div className={styles.statCard}>
          <div className={styles.statIcon} style={{ background: '#f1f5f9', color: '#15803d' }}><ShoppingBag size={24} /></div>
          <div className={styles.statInfo}>
        ...
        <div className={styles.statCard}>
          <div className={styles.statIcon} style={{ background: '#f1f5f9', color: '#be185d' }}><Package size={24} /></div>
          <div className={styles.statInfo}>
        ...
        <div className={styles.statCard}>
          <div className={styles.statIcon} style={{ background: '#f1f5f9', color: '#c2410c' }}><Users size={24} /></div>
          <div className={styles.statInfo}>
