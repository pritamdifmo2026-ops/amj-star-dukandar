...
import { Eye, Package, Copy, CheckCircle, Share2, ExternalLink, MessageCircle, Camera, TrendingUp, ToggleLeft, ToggleRight, Tag, ChevronRight, Sparkles, Globe } from 'lucide-react';
...
const ResellerStorefront: React.FC = () => {
  ...
  const storeSlug = (profile?.fullName || user?.name || 'reseller').toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '');
