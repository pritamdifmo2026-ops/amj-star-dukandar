...
const mapProduct = (item: any): Product => {
  ...
  return {
    ...
    categoryId: item.categoryId?._id ? String(item.categoryId._id) : (item.categoryId ? String(item.categoryId) : undefined),
    subcategoryId: item.subcategoryId?._id ? String(item.subcategoryId._id) : (item.subcategoryId ? String(item.subcategoryId) : undefined),
