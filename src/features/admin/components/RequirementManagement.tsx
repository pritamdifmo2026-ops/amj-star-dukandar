              ...
              <div className="border-t border-slate-100 bg-slate-50 p-4 rounded-b-lg">
                ...
                <div className="mb-3">
                  ...
                  <div className="flex gap-2 mt-1">
                    ...
                    <button className="px-3 py-1.5 bg-blue-600 text-white rounded text-sm font-semibold hover:bg-blue-700 disabled:opacity-50" onClick={() => assignMutation.mutate({ id: selectedReq._id, supplierId: selectedSupplierToAssign })} disabled={!selectedSupplierToAssign || assignMutation.isPending}>Assign</button>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-2">
                  <button className="w-full flex justify-center items-center py-2.5 rounded-lg text-sm font-semibold bg-blue-50 border border-blue-200 text-blue-700 hover:bg-blue-100 disabled:opacity-50" onClick={() => {
                  ...
                  <button className="w-full flex justify-center items-center py-2.5 rounded-lg text-sm font-semibold bg-green-50 border border-green-200 text-green-700 hover:bg-green-100" onClick={() => window.location.href = `tel:${selectedReq.buyerPhone}`}>
                    Call Buyer
                  </button>
                </div>
                <button className="w-full flex justify-center items-center py-2.5 mt-2 rounded-lg text-sm font-semibold border border-red-200 bg-red-50 text-red-600 hover:bg-red-100 hover:border-red-300 disabled:opacity-50 disabled:cursor-not-allowed" onClick={() => updateStatusMutation.mutate({ id: selectedReq._id, status: 'Closed' })} disabled={selectedReq.status === 'Closed' || updateStatusMutation.isPending}>
                  Mark as Closed
                </button>
              </div>
            </div>
