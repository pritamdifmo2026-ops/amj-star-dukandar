  ...
  return (
    <div className={styles.dashboardOverview}>
      <div className={styles.statsGrid}>
        ...
        <div className={styles.statCard}>
          <TrendingUp color="oklch(0.55 0.16 38)" />
          <div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={growthData}>
                ...
                <Line 
                  ...
                  strokeWidth={2}
                  dot={{ r: 4, fill: 'oklch(0.55 0.16 38)' }} 
        ...
        <div className={styles.chartCard}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ flex: 1, height: '8px', background: '#f1f5f9', margin: '0 15px', borderRadius: '4px', overflow: 'hidden' }}>
                <div style={{ width: `${(stats.totalResellers / (stats.totalResellers + stats.pendingResellers)) * 100}%`, height: '100%', background: 'oklch(0.55 0.16 38)' }} />
              </div>
