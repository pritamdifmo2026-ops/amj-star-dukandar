      ...
      <div className="bg-surface min-h-screen">
        <section className="bg-gradient-to-br from-white to-[oklch(0.97_0.02_75)] pt-24 pb-14 border-b border-border">
          <div className="max-w-[var(--width-container)] mx-auto px-4 sm:px-8 text-center">
            ...
            <p className="text-body text-base max-w-lg mx-auto leading-relaxed">
              Find answers to common questions about setting up your storefront, managing leads, and partnering with suppliers.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-[var(--width-container)] mx-auto px-4 sm:px-8 py-14 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12">
          ...
          <div className="flex flex-col gap-6">
            <div>
              <h2 className="text-lg font-extrabold text-heading mb-1">Reseller Support</h2>
              <p className="text-sm text-body">Our team is here to help you grow your business.</p>
            </div>
              ...
              <div className="flex flex-col gap-3">
                <details className="group cursor-pointer">
                  ...
                  <p className="text-xs text-body leading-relaxed pl-2 border-l-2 border-primary/20">
                    Once verified, you can set up your storefront from your Reseller Dashboard under the 'Storefront' tab. Add your logo, brand name, and custom colors.
                  </p>
                </details>
                <details className="group cursor-pointer">
                  <summary className="text-sm font-bold text-heading hover:text-primary transition-colors mb-1 list-none flex justify-between">
                    How do I partner with suppliers?
                  </summary>
                  <p className="text-xs text-body leading-relaxed pl-2 border-l-2 border-primary/20">
                    Browse the catalog, find products you want to sell, and click 'Request Partnership'. Once the supplier approves, you can add those products to your storefront.
                  </p>
                </details>
                <details className="group cursor-pointer">
                  <summary className="text-sm font-bold text-heading hover:text-primary transition-colors mb-1 list-none flex justify-between">
                  ...
                  <p className="text-xs text-body leading-relaxed pl-2 border-l-2 border-primary/20">
                    When buyers submit enquiries on your public storefront, they will appear in your 'Leads' tab. You can then connect them directly with your partnered suppliers.
                  </p>
                </details>
              </div>
            </div>
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-body max-w-sm mx-auto">
                  Thank you for reaching out. Our reseller success team will contact you shortly.
                </p>
                <button
                  onClick={() => {
                    setSubmitted(false);
